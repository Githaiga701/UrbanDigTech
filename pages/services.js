      ...
      <main className="py-12">
        <div className="container-max">
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
            <Link href="/services/managed-it"><a className="block p-6 bg-white rounded-lg shadow hover:shadow-md transform hover:scale-105 transition duration-200">
            ...
            <Link href="/services/cloud"><a className="block p-6 bg-white rounded-lg shadow hover:shadow-md transform hover:scale-105 transition duration-200">
            ...
            <Link href="/services/cybersecurity"><a className="block p-6 bg-white rounded-lg shadow hover:shadow-md transform hover:scale-105 transition duration-200">
